...
data.  This example retrieves values for a specific date (YYYY-MM-DD).
"""
import os
import json
...
#
# latest: ver:"3.0" range:"2025-11-01" id @d7180b62-f926-4d22-812f-ed18b5c91937 @e8791f69-167c-47a2-8f9e-f25dd899b418
