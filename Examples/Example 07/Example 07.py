...
ids = tools.get_ids_by_query(query_string)                                          # Retrieve a data frame containing the necessary IDs
...
for row in historical_df.iterrows():
    ...
    # trend_df['time'] = pd.to_datetime(trend_df['ts'].str.split(r"[: ]").str[1], format="ISO8601")    # Convert to datetime object
